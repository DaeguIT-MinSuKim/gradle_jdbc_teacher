...
public class Employee {
	...
	public String toDebug() {
		return String.format("[%s %s %s %s %s %s %s %s %s]", empNo, empName, title.getTitleNo(), manager.getEmpNo(),
				salary, dept.getDeptNo(), passwd == null ? "****" : passwd, String.format("%1$tF %1$tT", hireDate),
